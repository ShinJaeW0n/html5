<%@page import="org.apache.tomcat.util.digester.CallParamRule"%>
...
<%
	...
	String sql = "SELECT * FROM haksa.student";
%>	
<%	
	//외우거나 복사해서 쓰기
	try{
...
%>
	...
	<table border = "1" callpading ="2" cellspacing = "0"> 
	<tr>
		<th>학번</th>
		<th>이름</th>
		<th>학년</th>
...
<%
	...
	for(int i = 1; i <= rsmd.getColumnCount(); i++){
		...
		out.println(i + "번째 칼럼의 타입 이름: " + rsmd.getColumnTypeName(i) + "(" + rsmd.getColumnType(i) + ")" + "<br/>");
		out.println();
	}
	}catch(Exception e){
			e.printStackTrace();
