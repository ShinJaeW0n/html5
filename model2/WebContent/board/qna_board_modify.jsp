...
<body>
	...
	<section id = "writeForm">
		<h2>게시판글 수정</h2>
		<form action = "model2/boardReplyPro.do" method="post" name = "modifyForm">
			...
			<table>
				...
				<tr>
					...
					<td class = "td_right"><input type = "text" name = "board_subject" id = "board_subject"  value = "<%=article.getBoard_subject()%>"/>
					</td>
				</tr>
				<tr>
