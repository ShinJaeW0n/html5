...
public class BoardDAO {
	...
	public int insertArticle(BoardBean article) {
		...
		try {
			...
			System.out.println("boardInsert �뿉�윭: " + e);
		} finally {
			close(rs);
			close(pstmt);
		}
	...
	public int updateReadCount(int board_num) {
		...
		try {
			...
			System.out.println("updateReadCount �뿉�윭: " + e);
		} finally {
			close(pstmt);
		}
	...
	public BoardBean selectArticle(int board_num) {
		...
		try {
			...
			System.out.println("getDetail �뿉�윭: " + e);
		} finally {
			close(rs);
			close(pstmt);
		}
	...
	public boolean isArticleBoardWriter(int board_num, String pass) {
		...
		try {
			...
			System.out.println("isBoardWriter �뿉�윭: " + e);
		} finally {
			close(rs);
			close(pstmt);
		}
	...
	public int updateArticle(BoardBean article) {
		...
		try {
			...
			System.out.println("boardModify �뿉�윭: " + e);
		} finally {
			close(pstmt);
		}
	...
	public int deleteAticle(int board_num) {
		...
		try {
			...
			System.out.println("boardDelete �뿉�윭: " + e);
		} finally {
			close(pstmt);
		}
